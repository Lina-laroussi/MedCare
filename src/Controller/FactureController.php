...
class FactureController extends AbstractController
{
    ...
    public function new(Request $request, FactureRepository $factureRepository, UserRepository $userrepository, SluggerInterface $slugger , MailerServicePharmacie $mailer , PharmacieRepository $pharmacieRepository,FlashyNotifier $Flashy): Response
    {
        $user=$this->getUser();
        $facture = new Facture();
