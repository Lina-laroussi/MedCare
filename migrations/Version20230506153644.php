 ...
 */
final class Version20230506153644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fiche_assurance (id INT AUTO_INCREMENT NOT NULL, ordonnance_id INT DEFAULT NULL, pharmacien_id INT DEFAULT NULL, assureur_id INT DEFAULT NULL, remboursement_id INT DEFAULT NULL, facture_id_id INT DEFAULT NULL, num_adherent INT NOT NULL, description VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, image_facture VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BF0694462BF23B8F (ordonnance_id), INDEX IDX_BF069446CFDB96BE (pharmacien_id), INDEX IDX_BF06944680F7E20A (assureur_id), UNIQUE INDEX UNIQ_BF069446F61EE8B (remboursement_id), UNIQUE INDEX UNIQ_BF069446ED7016E0 (facture_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordonnance (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, code_ordonnance VARCHAR(255) NOT NULL, medicaments VARCHAR(255) NOT NULL, dosage VARCHAR(255) NOT NULL, nombre_jours INT NOT NULL, date_de_creation DATE NOT NULL, date_de_modification DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE remboursement (id INT AUTO_INCREMENT NOT NULL, fiche_assurance_id_id INT DEFAULT NULL, montant_a_rembourser DOUBLE PRECISION NOT NULL, montant_maximale DOUBLE PRECISION NOT NULL, taux_remboursement VARCHAR(255) NOT NULL, date_remboursement DATE NOT NULL, etat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C0C0D9EFE392FC9B (fiche_assurance_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
