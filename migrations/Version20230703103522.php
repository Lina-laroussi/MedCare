 ...
 */
final class Version20230703103522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, fiche_medicale_id INT DEFAULT NULL, ordonnance_id INT DEFAULT NULL, poids DOUBLE PRECISION NOT NULL, taille DOUBLE PRECISION NOT NULL, imc DOUBLE PRECISION NOT NULL, temperature DOUBLE PRECISION NOT NULL, prix DOUBLE PRECISION NOT NULL, pression_arterielle DOUBLE PRECISION NOT NULL, frequence_cardiaque DOUBLE PRECISION NOT NULL, taux_glycemie DOUBLE PRECISION NOT NULL, maladie VARCHAR(255) NOT NULL, traitement VARCHAR(255) NOT NULL, observation VARCHAR(255) NOT NULL, INDEX IDX_964685A69A99F4BC (fiche_medicale_id), UNIQUE INDEX UNIQ_964685A62BF23B8F (ordonnance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, ordonnance_id INT DEFAULT NULL, pharmacie_id INT DEFAULT NULL, montant DOUBLE PRECISION NOT NULL, etat VARCHAR(255) NOT NULL, date DATE NOT NULL, image_signature VARCHAR(255) NOT NULL, num_facture VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FE8664102BF23B8F (ordonnance_id), INDEX IDX_FE866410BC6D351B (pharmacie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fiche_assurance (id INT AUTO_INCREMENT NOT NULL, ordonnance_id INT DEFAULT NULL, pharmacien_id INT DEFAULT NULL, assureur_id INT DEFAULT NULL, facture_id INT DEFAULT NULL, num_adherent INT NOT NULL, description VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, image_facture VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BF0694462BF23B8F (ordonnance_id), INDEX IDX_BF069446CFDB96BE (pharmacien_id), INDEX IDX_BF06944680F7E20A (assureur_id), UNIQUE INDEX UNIQ_BF0694467F2DEE08 (facture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordonnance (id INT AUTO_INCREMENT NOT NULL, medicaments VARCHAR(255) NOT NULL, code_ordonnance VARCHAR(10) NOT NULL, description VARCHAR(255) NOT NULL, dosage VARCHAR(255) NOT NULL, nombre_jours INT NOT NULL, date_de_creation DATE NOT NULL, date_de_modification DATE NOT NULL, qr_code_filename VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pharmacie (id INT AUTO_INCREMENT NOT NULL, pharmacien_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, num_tel VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, horaire VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, matricule VARCHAR(255) NOT NULL, services VARCHAR(255) NOT NULL, gouvernorat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5FC19434CFDB96BE (pharmacien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE remboursement (id INT AUTO_INCREMENT NOT NULL, fiche_assurance_id INT DEFAULT NULL, montant_a_rembourser DOUBLE PRECISION NOT NULL, montant_maximale DOUBLE PRECISION NOT NULL, taux_remboursement VARCHAR(255) NOT NULL, date_remboursement DATE NOT NULL, etat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C0C0D9EFEE18DED6 (fiche_assurance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, num_tel VARCHAR(255) DEFAULT NULL, age VARCHAR(255) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, sexe VARCHAR(255) DEFAULT NULL, specialite VARCHAR(255) DEFAULT NULL, date_de_creation DATE NOT NULL, cin VARCHAR(255) DEFAULT NULL, num_securite_sociale INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, date_de_modification DATE DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, is_blocked TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
